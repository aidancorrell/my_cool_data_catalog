...
var mergeStyles = require('@fluentui/merge-styles');
...
var toposort__namespace = /*#__PURE__*/_interopNamespace(toposort);
...
exports.GraphEdgeStatus = void 0;
...
})(exports.GraphEdgeStatus || (exports.GraphEdgeStatus = {}));

exports.GraphNodeStatus = void 0;
...
})(exports.GraphNodeStatus || (exports.GraphNodeStatus = {}));

exports.GraphPortStatus = void 0;
...
})(exports.GraphPortStatus || (exports.GraphPortStatus = {}));
...
function isNodeEditing(node) {
  return has(exports.GraphNodeStatus.Editing)(node.status);
}
...
const resetConnectStatus = mask => prevStatus => {
  return (prevStatus || 0) & exports.GraphNodeStatus.Activated | mask;
};
...
const RectComponent = props => {
  ...
  return jsxRuntime.jsxs("g", {
    children: [jsxRuntime.jsx("rect", {
      ...
      children: node.name
    })), node.data && node.data.comment && !isEditing && jsxRuntime.jsx("text", Object.assign({
      x: node.x,
      y: textY + 20,
      fontSize: 12,
    ...
    })), isEditing && jsxRuntime.jsx("foreignObject", Object.assign({
      x: node.x,
      y: textY,
      height: height / 2.5,
      width: width - 5
...
const rect = {
  ...
  render(args) {
    ...
    const style = has(exports.GraphNodeStatus.Selected | exports.GraphNodeStatus.Activated)(node.status) ? {
    ...
    return jsxRuntime.jsx(RectComponent, {
      style: style,
      node: node,
      width: width,
      height: height,
...
const line = {
  render(args) {
    ...
    const style = {
      cursor: "crosshair",
      stroke: has(exports.GraphEdgeStatus.Selected)(edge.status) ? defaultColors.edgeColorSelected : defaultColors.edgeColor,
      strokeWidth: "2"
    };
...
class DefaultPort {
  getStyle(port, _parentNode, _data, connectedAsSource, connectedAsTarget) {
    ...
    if (has(exports.GraphPortStatus.Activated)(port.status)) {
  ...
  render(args) {
    ...
    return connectedAsTarget ? jsxRuntime.jsx("polygon", {
    ...
    try {
      ...
      return {
        nodes: data.nodes.map(n => {
          const newId = uuid__namespace.v4();
...
const GraphConfigContext = /*#__PURE__*/React.createContext(GraphConfigBuilder.default().build());
...
class ContextMenuConfig {
  ...
  getMenu(menuType) {
    if (this.contextMenuProps && this.contextMenu.has(menuType)) {
      ...
      const reactElement = /*#__PURE__*/React__namespace.createElement("div", {
        className,
        style: styles
...
const ContextMenuConfigContext = /*#__PURE__*/React__namespace.createContext(new ContextMenuConfig());
...
})(exports.GraphFeatures || (exports.GraphFeatures = {}));

const allFeatures = new Set([exports.GraphFeatures.NodeDraggable, exports.GraphFeatures.NodeResizable, exports.GraphFeatures.ClickNodeToSelect, exports.GraphFeatures.PanCanvas, exports.GraphFeatures.MultipleSelect, exports.GraphFeatures.LassoSelect, exports.GraphFeatures.Delete, exports.GraphFeatures.AddNewNodes, exports.GraphFeatures.AddNewEdges, exports.GraphFeatures.AddNewPorts, exports.GraphFeatures.CanvasHorizontalScrollable, exports.GraphFeatures.CanvasVerticalScrollable, exports.GraphFeatures.NodeHoverView, exports.GraphFeatures.PortHoverView, exports.GraphFeatures.AddEdgesByKeyboard, exports.GraphFeatures.A11yFeatures, exports.GraphFeatures.AutoFit, exports.GraphFeatures.EditNode, exports.GraphFeatures.AutoAlign, exports.GraphFeatures.UndoStack, exports.GraphFeatures.CtrlKeyZoom, exports.GraphFeatures.LimitBoundary, exports.GraphFeatures.EditEdge]);
const defaultFeatures = new Set([exports.GraphFeatures.NodeDraggable, exports.GraphFeatures.NodeResizable, exports.GraphFeatures.ClickNodeToSelect, exports.GraphFeatures.PanCanvas, exports.GraphFeatures.MultipleSelect, exports.GraphFeatures.Delete, exports.GraphFeatures.AddNewNodes, exports.GraphFeatures.AddNewEdges, exports.GraphFeatures.AddNewPorts, exports.GraphFeatures.CanvasHorizontalScrollable, exports.GraphFeatures.CanvasVerticalScrollable, exports.GraphFeatures.NodeHoverView, exports.GraphFeatures.PortHoverView, exports.GraphFeatures.AddEdgesByKeyboard, exports.GraphFeatures.A11yFeatures, exports.GraphFeatures.EditNode, exports.GraphFeatures.AutoAlign, exports.GraphFeatures.UndoStack, exports.GraphFeatures.CtrlKeyZoom, exports.GraphFeatures.LimitBoundary]);
const dataReadonlyMode = new Set([exports.GraphFeatures.NodeDraggable, exports.GraphFeatures.NodeResizable, exports.GraphFeatures.ClickNodeToSelect, exports.GraphFeatures.PanCanvas, exports.GraphFeatures.MultipleSelect, exports.GraphFeatures.CanvasHorizontalScrollable, exports.GraphFeatures.CanvasVerticalScrollable, exports.GraphFeatures.NodeHoverView, exports.GraphFeatures.PortHoverView, exports.GraphFeatures.A11yFeatures, exports.GraphFeatures.CtrlKeyZoom, exports.GraphFeatures.LimitBoundary]);
const GanttChartFeatures = new Set([exports.GraphFeatures.ClickNodeToSelect, exports.GraphFeatures.CanvasHorizontalScrollable, exports.GraphFeatures.CanvasVerticalScrollable, exports.GraphFeatures.NodeHoverView, exports.GraphFeatures.PortHoverView, exports.GraphFeatures.A11yFeatures, exports.GraphFeatures.LassoSelect, exports.GraphFeatures.LimitBoundary]);
const previewMode = new Set([exports.GraphFeatures.NodeHoverView, exports.GraphFeatures.PortHoverView, exports.GraphFeatures.AutoFit]);
...
const getBrowser = () => {
  ...
  if (agent.indexOf("electron") > -1) {
    return exports.BrowserType.Electron; // UserAgent of electron is weird.
  }
  ...
  switch (true) {
    ...
    case agent.indexOf("edg") > -1:
      return exports.BrowserType.EdgeChromium;
    ...
    case agent.indexOf("trident") > -1:
      return exports.BrowserType.IE;

    case agent.indexOf("firefox") > -1:
      return exports.BrowserType.Firefox;

    case agent.indexOf("safari") > -1:
      return exports.BrowserType.Safari;

    default:
      return exports.BrowserType.Unknown;
  }
};
const isSupported = () => {
  if (isMobile()) {
  ...
  const supported = [exports.BrowserType.Chrome, exports.BrowserType.EdgeChromium, exports.BrowserType.Firefox, exports.BrowserType.Safari, exports.BrowserType.Electron];
...
function resetNodePortsState(node) {
  return node.updatePorts(updateStatus(replace(exports.GraphPortStatus.Default)));
}
...
const unSelectAllEntity = () => {
  return data => data.mapNodes(n => n.update(curNode => {
    ...
    const nextNode = Object.assign(Object.assign({}, curNode), {
      ports: (_a = curNode.ports) === null || _a === void 0 ? void 0 : _a.map(updateStatus(replace(exports.GraphPortStatus.Default)))
    });
    return updateStatus(replace(exports.GraphNodeStatus.Default))(nextNode);
  })).mapEdges(e => e.update(updateStatus(replace(exports.GraphEdgeStatus.Default))));
};
...
class GraphModel {
  ...
  deleteItems(predicate) {
    ...
    while (node !== undefined) {
      ...
      if (!((_a = predicate.node) === null || _a === void 0 ? void 0 : _a.call(predicate, node.inner))) {
        ...
        nodes.update(node.id, current => current.link({
          ...
          if (has(exports.GraphNodeStatus.Editing)(n.status)) {
            return n;
          }

          return Object.assign(Object.assign({}, n), {
            status: exports.GraphNodeStatus.Default
          });
        }));
        prev = node;
      }
    ...
    this.edges.forEach(edge => {
      ...
      if (!deleted.has(edge.source) && !deleted.has(edge.target) && ((_b = (_a = predicate.edge) === null || _a === void 0 ? void 0 : _a.call(predicate, edge)) !== null && _b !== void 0 ? _b : true)) {
        edges.update(edge.id, e => e.update(updateStatus(replace(exports.GraphEdgeStatus.Default))));
      } else {
  ...
  insertEdge(edge) {
    ...
    return this.merge({
      ...
      edges: this.edges.set(edge.id, EdgeModel.fromJSON(edge)).map(e => e.updateStatus(replace(exports.GraphEdgeStatus.Default))),
      edgesBySource,
      edgesByTarget
    });
  }
  ...
  selectNodes(predicate, topNode) {
    ...
    const nodes = this.nodes.map(node => {
      ...
      return node.updatePorts(updateStatus(replace(exports.GraphPortStatus.Default))).updateStatus(resetConnectStatus(isNodeSelected ? exports.GraphNodeStatus.Selected : exports.GraphNodeStatus.UnconnectedToSelected));
    }).mutate();

    if (selected.size === 0) {
      this.nodes.forEach(n => nodes.update(n.id, it => it.updateStatus(replace(exports.GraphNodeStatus.Default))));
    } else if (topNode) {
    ...
    const setConnected = id => {
      nodes.update(id, node => node.updateStatus(replace(isSelected(node) ? exports.GraphNodeStatus.Selected : exports.GraphNodeStatus.ConnectedToSelected)));
    };

    const edges = selected.size ? this.edges.map(edge => {
      let state = exports.GraphEdgeStatus.UnconnectedToSelected;

      if (selected.has(edge.source)) {
        setConnected(edge.target);
        state = exports.GraphEdgeStatus.ConnectedToSelected;
      }
    ...
    }) : this.edges.map(edge => edge.updateStatus(replace(exports.GraphEdgeStatus.Default)));
    return this.merge({
      nodes: nodes.finish(),
      edges,
...
exports.CanvasMouseMode = void 0;

(function (CanvasMouseMode) {
  CanvasMouseMode["Pan"] = "Pan";
  CanvasMouseMode["Select"] = "Select";
})(exports.CanvasMouseMode || (exports.CanvasMouseMode = {}));
...
})(exports.GraphBehavior || (exports.GraphBehavior = {}));
...
const getTopoSortingNodes = canvasData => {
  ...
  const orderOfNodeIds = toposort__namespace.array(nodesForTopo, edgesForTopo);
  const newNodes = [];
...
const getZoomFitMatrix = args => {
  ...
  const scaleCommon = direction === exports.Direction.Y ? Math.min(Math.max(minScaleX, minScaleY, scaleY), maxScaleX, maxScaleY) : Math.min(Math.max(minScaleX, minScaleY, Math.min(scaleX, scaleY)), maxScaleY, maxScaleY);
  const newScaleX = direction === exports.Direction.XY ? Math.min(Math.max(minScaleX, scaleX), maxScaleX) : scaleCommon;
  const newScaleY = direction === exports.Direction.XY ? Math.min(Math.max(minScaleY, scaleY), maxScaleY) : scaleCommon;
...
function createGraphState(params) {
  ...
  return {
    ...
    behavior: exports.GraphBehavior.Default,
...
const ViewportContext = /*#__PURE__*/React.createContext(EMPTY_VIEW_PORT);
...
const GraphValueContext = /*#__PURE__*/React__namespace.createContext(new Proxy(GraphModel.empty(), {
  get: (target, prop) => {
...
const GraphStateContext = /*#__PURE__*/React__namespace.createContext(defaultGraphStateContext);
...
class EventChannel {
  constructor() {
    this.listenersRef = /*#__PURE__*/React.createRef();
    this.externalHandlerRef = /*#__PURE__*/React.createRef();
    this.queue = [];
    this.working = false;
  }
...
class GraphController {
  constructor(state, dispatch) {
    ...
    this.behavior = exports.GraphBehavior.Default;
...
class ErrorBoundary extends React__namespace.Component {
  ...
  render() {
    ...
    return jsxRuntime.jsxs("div", Object.assign({
      ...
      }), (componentStackLines !== null && componentStackLines !== void 0 ? componentStackLines : []).map((line, index) => jsxRuntime.jsx("p", {
        children: line
      }, index))]
    }));
  }
...
const ConnectingStateContext = /*#__PURE__*/React.createContext(EMPTY_CONNECT_CONTEXT);
...
const ConnectingState = ({
  ...
  return jsxRuntime.jsx(ConnectingStateContext.Provider, Object.assign({
    value: context
  }, {
    children: children
  }));
...
const AlignmentLinesContext = /*#__PURE__*/React.createContext([]);

const GraphControllerContext = /*#__PURE__*/React.createContext(new GraphController(EMPTY_GRAPH_STATE, noop));
...
function GraphStateStore(props) {
  ...
  return jsxRuntime.jsx(GraphConfigContext.Provider, Object.assign({
    value: state.settings.graphConfig
  }, {
    children: jsxRuntime.jsx(GraphControllerContext.Provider, Object.assign({
      value: graphController
    }, {
      children: jsxRuntime.jsx(ConnectingState, Object.assign({
        data: state.data.present,
        connectState: state.connectState
      }, {
        children: jsxRuntime.jsx(GraphStateContext.Provider, Object.assign({
          value: contextValue
        }, {
          children: jsxRuntime.jsx(ViewportContext.Provider, Object.assign({
            value: state.viewport
          }, {
            children: jsxRuntime.jsx(GraphValueContext.Provider, Object.assign({
              value: state.data.present
            }, {
              children: jsxRuntime.jsx(AlignmentLinesContext.Provider, Object.assign({
...
const ReactDagEditor = props => {
  ...
  return jsxRuntime.jsx(ErrorBoundary, Object.assign({
    renderOnError: handleError
  }, {
    children: jsxRuntime.jsx(SlotsContext.Provider, Object.assign({
      value: props
    }, {
      children: jsxRuntime.jsx(GraphStateStore, Object.assign({
        state: state,
        dispatch: dispatch,
        graphController: graphController
      }, {
        children: jsxRuntime.jsx(ContextMenuConfigContext.Provider, Object.assign({
...
const useContextMenuConfigContext = () => {
  return React__namespace.useContext(ContextMenuConfigContext);
};

exports.GraphNodeEvent = void 0;
...
})(exports.GraphNodeEvent || (exports.GraphNodeEvent = {}));

exports.GraphEdgeEvent = void 0;
...
})(exports.GraphEdgeEvent || (exports.GraphEdgeEvent = {}));

exports.GraphPortEvent = void 0;
...
})(exports.GraphPortEvent || (exports.GraphPortEvent = {}));

exports.GraphCanvasEvent = void 0;
...
})(exports.GraphCanvasEvent || (exports.GraphCanvasEvent = {}));

exports.GraphScrollBarEvent = void 0;
...
})(exports.GraphScrollBarEvent || (exports.GraphScrollBarEvent = {}));

exports.GraphMinimapEvent = void 0;
...
})(exports.GraphMinimapEvent || (exports.GraphMinimapEvent = {}));

exports.GraphContextMenuEvent = void 0;

(function (GraphContextMenuEvent) {
  GraphContextMenuEvent["Open"] = "[ContextMenu]Open";
  GraphContextMenuEvent["Close"] = "[ContextMenu]Close";
})(exports.GraphContextMenuEvent || (exports.GraphContextMenuEvent = {}));
...
function getScrollLineHeight() {
  try {
    ...
    contentDocument.documentElement.innerHTML = DOMPurify__default["default"].sanitize("<span>a</span>", {
...
const VirtualizationContext = /*#__PURE__*/React.createContext({
  viewport: {
    rect: EMPTY_RECT,
    transformMatrix: EMPTY_TRANSFORM_MATRIX
  },
...
function useGraphController() {
  return React.useContext(GraphControllerContext);
}
function useViewport() {
  return React.useContext(ViewportContext);
}
function useAlignmentLines() {
  return React.useContext(AlignmentLinesContext);
}
function useConnectingState() {
  return React.useContext(ConnectingStateContext);
}
function useVirtualization() {
  return React.useContext(VirtualizationContext);
}
    ...
    const onWheel = e => {
      ...
      if (e.ctrlKey && isCtrlKeyZoomEnable) {
        ...
        eventChannel.trigger({
          type: exports.GraphCanvasEvent.Zoom,
          rawEvent: e,
          scale,
      ...
      eventChannel.trigger({
        type: exports.GraphCanvasEvent.MouseWheelScroll,
        dx,
        dy,
        rawEvent: e
      });
...
const useUpdateViewportCallback = (rectRef, svgRef, eventChannel) => React.useCallback((force = false) => {
  var _a;
  ...
  if (force || isRectChanged(rectRef.current, viewportRect)) {
    ...
    eventChannel.trigger({
      type: exports.GraphCanvasEvent.ViewportResize,
      viewportRect
    });
  }
...
function useThrottle(callback, limit, deps) {
   ...
   */
  // eslint-disable-next-line react-hooks/exhaustive-deps
  return React.useMemo(() => throttle(callback, limit), deps);
}
...
class TwoFingerHandler {
  ...
  onMove(pointers, e) {
    ...
    this.eventChannel.trigger({
      type: exports.GraphCanvasEvent.Pinch,
      rawEvent: e,
      dx,
      dy,
      scale,
...
/* eslint-disable @typescript-eslint/ban-ts-comment */
const isSafari = getBrowser() === exports.BrowserType.Safari;
let prevScale = 0;
...
const useSelectBox = (dispatch, selectBoxPositionState) => {
  ...
  React__namespace.useEffect(() => {
    dispatch({
      type: exports.GraphCanvasEvent.UpdateNodeSelectionBySelectBox
    }); // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [selectBoxPosition]);
};
...
const useGraphData = () => {
  return React.useContext(GraphValueContext);
};
...
const handleBehaviorChange = (prevBehavior, event) => {
  switch (event.type) {
    case exports.GraphNodeEvent.DragStart:
      return exports.GraphBehavior.Dragging;

    case exports.GraphEdgeEvent.ConnectStart:
      return exports.GraphBehavior.Connecting;

    case exports.GraphCanvasEvent.SelectStart:
      return exports.GraphBehavior.MultiSelect;

    case exports.GraphCanvasEvent.DragStart:
      return exports.GraphBehavior.Panning;

    case exports.GraphCanvasEvent.DraggingNodeFromItemPanelStart:
      return exports.GraphBehavior.AddingNode;

    case exports.GraphNodeEvent.DragEnd:
    case exports.GraphEdgeEvent.ConnectEnd:
    case exports.GraphCanvasEvent.SelectEnd:
    case exports.GraphCanvasEvent.DragEnd:
    case exports.GraphCanvasEvent.DraggingNodeFromItemPanelEnd:
      return exports.GraphBehavior.Default;
...
const canvasReducer = (state, action) => {
  switch (action.type) {
    case exports.GraphCanvasEvent.Paste:
      {
        const {
          position
        } = action;
        ...
        if (position && rect) {
          ...
          pasteNodes = pasteNodes.map((n, idx) => {
            ...
            return Object.assign(Object.assign({}, n), {
              ...
              state: exports.GraphNodeStatus.Selected
            });
          });
        }
    ...
    case exports.GraphCanvasEvent.Delete:
      if (!state.settings.features.has(exports.GraphFeatures.Delete)) {
        return state;
      }
    ...
    case exports.GraphCanvasEvent.Undo:
      return Object.assign(Object.assign({}, state), {
        data: undo(state.data)
      });

    case exports.GraphCanvasEvent.Redo:
      return Object.assign(Object.assign({}, state), {
        data: redo(state.data)
      });

    case exports.GraphCanvasEvent.KeyDown:
      {
    ...
    case exports.GraphCanvasEvent.KeyUp:
      {
        const key = action.rawEvent.key.toLowerCase();
    ...
    case exports.GraphCanvasEvent.SetData:
      return Object.assign(Object.assign({}, state), {
        data: resetUndoStack(action.data)
      });

    case exports.GraphCanvasEvent.UpdateData:
      return Object.assign(Object.assign({}, state), {
    ...
    case exports.GraphCanvasEvent.ResetUndoStack:
      return Object.assign(Object.assign({}, state), {
        data: resetUndoStack(state.data.present)
      });

    case exports.GraphCanvasEvent.UpdateSettings:
      {
...
const VisitPortHelper = props => {
  ...
  const [selectedItem, setSelectedItem] = React__namespace.useState();
  const onContainerKeyDown = React__namespace.useCallback(evt => {
    if (evt.key === "Escape") {
      evt.stopPropagation();
      evt.preventDefault();
  ...
  const onContainerBlur = React__namespace.useCallback(() => {//
  }, []);
  const onContainerChange = React__namespace.useCallback(evt => {
  ...
  return jsxRuntime.jsx("select", Object.assign({
...
const focusItem = (svgRef, nextItem, evt, eventChannel) => {
  ...
  if (el) {
    ...
    eventChannel.trigger({
      type: exports.GraphCanvasEvent.Navigate,
      node: nextItem.node,
      port: nextItem.port,
      rawEvent: evt
    });
...
const getFocusNodeHandler = compareFn => (data, curNodeId, svgRef, graphController, evt, eventChannel) => {
  ...
  if (nextNode && svgRef.current) {
    graphController.dispatch({
      type: exports.GraphNodeEvent.Select,
      nodes: [nextNode.id]
    });
    graphController.dispatch({
      type: exports.GraphNodeEvent.Centralize,
      nodes: [nextNode.id]
    });
    focusItem(svgRef, {
      node: nextNode,
...
const goToConnectedPort = (data, node, port, svgRef, evt, eventChannel) => {
  ...
  if (neighborPorts.length === 1 && svgRef.current) {
    ...
    const onComplete = nextPort => {
      ...
      ReactDOM__namespace.unmountComponentAtNode(visitPortHelperContainer);
    ...
    ReactDOM__namespace.render(jsxRuntime.jsx(VisitPortHelper, {
...
function attachPort(state, nodeId, portId) {
  ...
  data = data.updatePort(nodeId, portId, updateStatus(add(exports.GraphPortStatus.ConnectingAsTarget)));

  if (state.connectState.targetNode && state.connectState.targetPort) {
    data = data.updatePort(state.connectState.targetNode, state.connectState.targetPort, updateStatus(remove(exports.GraphPortStatus.ConnectingAsTarget)));
  }
...
function clearAttach(state) {
  ...
  if (targetNode && targetPort) {
    data = data.updatePort(targetNode, targetPort, updateStatus(remove(exports.GraphPortStatus.ConnectingAsTarget)));
  }
  ...
  switch (action.type) {
    case exports.GraphEdgeEvent.ConnectStart:
      return Object.assign(Object.assign({}, state), {
        ...
        data: Object.assign(Object.assign({}, state.data), {
          present: state.data.present.updatePort(action.nodeId, action.portId, updateStatus(add(exports.GraphPortStatus.Connecting)))
        })
      });

    case exports.GraphEdgeEvent.ConnectMove:
      if (state.connectState) {
        return Object.assign(Object.assign({}, state), {
          connectState: Object.assign(Object.assign({}, state.connectState), {
            movingPoint: {
    ...
    case exports.GraphEdgeEvent.ConnectEnd:
      if (state.connectState) {
        ...
        let data = state.data.present;
        data = data.updatePort(sourceNode, sourcePort, updateStatus(replace(exports.GraphPortStatus.Default)));
        ...
        if (!isCancel && targetNode && targetPort) {
          let edge = {
            ...
            id: uuid.v4(),
            status: exports.GraphEdgeStatus.Default
          };
          ...
          data = data.insertEdge(edge).updatePort(targetNode, targetPort, updateStatus(replace(exports.GraphPortStatus.Default)));
          return Object.assign(Object.assign({}, state), {
            connectState: undefined,
    ...
    case exports.GraphEdgeEvent.ConnectNavigate:
      if (state.connectState) {
    ...
    case exports.GraphPortEvent.PointerEnter:
      if (state.connectState) {
        const {
          sourceNode,
          sourcePort
    ...
    case exports.GraphNodeEvent.PointerEnter:
    case exports.GraphNodeEvent.PointerMove:
      if (state.connectState) {
        const {
          clientX,
          clientY
    ...
    case exports.GraphNodeEvent.PointerLeave:
    ...
    case exports.GraphPortEvent.PointerLeave:
...
const contextMenuReducer = (prevState, action) => {
  ...
  switch (action.type) {
    case exports.GraphCanvasEvent.ContextMenu:
    case exports.GraphNodeEvent.ContextMenu:
    case exports.GraphEdgeEvent.ContextMenu:
    case exports.GraphPortEvent.ContextMenu:
      {
    ...
    case exports.GraphCanvasEvent.Click:
    case exports.GraphNodeEvent.Click:
    case exports.GraphEdgeEvent.Click:
    case exports.GraphPortEvent.Click:
      nextContextMenuPosition = undefined;
      break;

    case exports.GraphContextMenuEvent.Open:
      nextContextMenuPosition = {
        x: action.x,
        y: action.y
      };
    ...
    case exports.GraphContextMenuEvent.Close:
      nextContextMenuPosition = undefined;
      break;
  }
...
const edgeReducer = (state, action) => {
  switch (action.type) {
    case exports.GraphEdgeEvent.DoubleClick:
      if (!state.settings.features.has(exports.GraphFeatures.EditEdge)) {
        return state;
      }

      return Object.assign(Object.assign({}, state), {
        data: Object.assign(Object.assign({}, state.data), {
          present: state.data.present.updateEdge(action.edge.id, updateStatus(replace(exports.GraphEdgeStatus.Editing)))
        })
      });

    case exports.GraphEdgeEvent.MouseEnter:
      return Object.assign(Object.assign({}, state), {
        data: Object.assign(Object.assign({}, state.data), {
          present: state.data.present.updateEdge(action.edge.id, updateStatus(add(exports.GraphEdgeStatus.Activated)))
        })
      });

    case exports.GraphEdgeEvent.MouseLeave:
      return Object.assign(Object.assign({}, state), {
        data: Object.assign(Object.assign({}, state.data), {
          present: state.data.present.updateEdge(action.edge.id, updateStatus(remove(exports.GraphEdgeStatus.Activated)))
        })
      });
    ...
    case exports.GraphEdgeEvent.ContextMenu:
      return Object.assign(Object.assign({}, state), {
        data: Object.assign(Object.assign({}, state.data), {
          present: unSelectAllEntity()(state.data.present).updateEdge(action.edge.id, updateStatus(add(exports.GraphEdgeStatus.Selected)))
        })
      });

    case exports.GraphEdgeEvent.Add:
      return Object.assign(Object.assign({}, state), {
...
function dragNodeHandler(state, event) {
  ...
  const viewport = viewportDx !== 0 || viewportDx !== 0 ? pipe(pan(-viewportDx, -viewportDy), zoom({
    scale,
    anchor: getRelativePoint(rect, e),
    direction: exports.Direction.XY,
    limitScale
...
function handleDraggingNewNode(state, action) {
  if (!state.settings.features.has(exports.GraphFeatures.AutoAlign)) {
    return state;
  }
...
function locateNode(action, state) {
  ...
  if (action.nodes.length === 1) {
    ...
    const nodeX = action.type === exports.GraphNodeEvent.Centralize ? node.x + width / 2 : node.x;
    const nodeY = action.type === exports.GraphNodeEvent.Centralize ? node.y + height / 2 : node.y;
    const {
      x: clientX,
      y: clientY
    } = transformPoint(nodeX, nodeY, state.viewport.transformMatrix);
    const position = action.type === exports.GraphNodeEvent.Locate ? action.position : undefined;
    return Object.assign(Object.assign({}, state), {
...
const nodeReducer = (state, action) => {
  ...
  switch (action.type) {
    //#region resize
    case exports.GraphNodeEvent.ResizingStart:
      return Object.assign(Object.assign({}, state), {
        dummyNodes: Object.assign(Object.assign({}, emptyDummyNodes()), {
          isVisible: true,
    ...
    case exports.GraphNodeEvent.Resizing:
      return Object.assign(Object.assign({}, state), {
    ...
    case exports.GraphNodeEvent.ResizingEnd:
      {
        const {
          dx,
          dy,
    ...
    case exports.GraphNodeEvent.Drag:
    ...
    case exports.GraphNodeEvent.PointerEnter:
      switch (state.behavior) {
        case exports.GraphBehavior.Default:
          return Object.assign(Object.assign({}, state), {
            data: Object.assign(Object.assign({}, state.data), {
              present: data.updateNode(action.node.id, updateStatus(add(exports.GraphNodeStatus.Activated)))
            })
          });
    ...
    case exports.GraphNodeEvent.PointerLeave:
      switch (state.behavior) {
        case exports.GraphBehavior.Default:
        case exports.GraphBehavior.Connecting:
          return Object.assign(Object.assign({}, state), {
            data: Object.assign(Object.assign({}, state.data), {
              present: data.updateNode(action.node.id, updateStatus(remove(exports.GraphNodeStatus.Activated)))
            })
          });
    ...
    case exports.GraphCanvasEvent.DraggingNodeFromItemPanel:
        ...
        if (action.node) {
          return Object.assign(Object.assign({}, state), {
            ...
            data: pushHistory(state.data, state.data.present.insertNode(Object.assign(Object.assign({}, action.node), {
              status: exports.GraphNodeStatus.Selected
            })), unSelectAllEntity())
          });
        }
    ...
    case exports.GraphNodeEvent.Centralize:
    case exports.GraphNodeEvent.Locate:
      return locateNode(action, state);

    case exports.GraphNodeEvent.Add:
      return Object.assign(Object.assign({}, state), {
        data: pushHistory(state.data, data.insertNode(action.node))
      });

    case exports.GraphNodeEvent.DoubleClick:
      return Object.assign(Object.assign({}, state), {
        data: Object.assign(Object.assign({}, state.data), {
          present: state.data.present.updateNode(action.node.id, updateStatus(add(exports.GraphNodeStatus.Editing)))
        })
      });
...
const portReducer = (state, action) => {
  switch (action.type) {
    case exports.GraphPortEvent.Focus:
    case exports.GraphPortEvent.PointerEnter:
      return Object.assign(Object.assign({}, state), {
        data: Object.assign(Object.assign({}, state.data), {
          present: state.data.present.updatePort(action.node.id, action.port.id, updateStatus(add(exports.GraphPortStatus.Activated)))
        })
      });

    case exports.GraphPortEvent.Blur:
    case exports.GraphPortEvent.PointerLeave:
      return Object.assign(Object.assign({}, state), {
        data: Object.assign(Object.assign({}, state.data), {
          present: state.data.present.updatePort(action.node.id, action.port.id, updateStatus(remove(exports.GraphPortStatus.Activated)))
        })
      });
    ...
    case exports.GraphPortEvent.ContextMenu:
      return Object.assign(Object.assign({}, state), {
        data: Object.assign(Object.assign({}, state.data), {
          present: unSelectAllEntity()(state.data.present).updatePort(action.node.id, action.port.id, updateStatus(add(exports.GraphPortStatus.Selected)))
        })
      });
...
function handleNavigate(state, action) {
  ...
  if (action.node && action.port) {
    data = data.updatePort(action.node.id, action.port.id, updateStatus(add(exports.GraphPortStatus.Selected)));
  } else if (action.node) {
...
const selectionReducer = (state, action) => {
  ...
  const data = state.data.present;
  const isLassoSelectEnable = state.settings.features.has(exports.GraphFeatures.LassoSelect);

  switch (action.type) {
    case exports.GraphCanvasEvent.Click:
    case exports.GraphCanvasEvent.ResetSelection:
    case exports.GraphCanvasEvent.ContextMenu:
      return Object.assign(Object.assign({}, state), {
        data: Object.assign(Object.assign({}, state.data), {
    ...
    case exports.GraphCanvasEvent.SelectMove:
      if (state.behavior !== exports.GraphBehavior.MultiSelect) {
        return state;
      }
    ...
    case exports.GraphCanvasEvent.UpdateNodeSelectionBySelectBox:
      {
        if (state.behavior !== exports.GraphBehavior.MultiSelect) {
          return state;
        }
    ...
    case exports.GraphCanvasEvent.Navigate:
      return handleNavigate(state, action);

    case exports.GraphNodeEvent.SelectAll:
      return Object.assign(Object.assign({}, state), {
        data: Object.assign(Object.assign({}, state.data), {
    ...
    case exports.GraphNodeEvent.Select:
      {
...
const reducer = (viewport, action, data, settings) => {
  ...
  switch (action.type) {
    case exports.GraphCanvasEvent.ViewportResize:
      return Object.assign(Object.assign({}, viewport), {
        rect: action.viewportRect
      });

    case exports.GraphCanvasEvent.Zoom:
      if (!isViewportComplete(viewport)) {
        return viewport;
      }
    ...
    case exports.GraphScrollBarEvent.Scroll:
    case exports.GraphCanvasEvent.MouseWheelScroll:
    case exports.GraphCanvasEvent.Pan:
    case exports.GraphCanvasEvent.Drag:
      {
        if (!isViewportComplete(viewport)) {
          return viewport;
        }
        ...
        const limitBoundary = features.has(exports.GraphFeatures.LimitBoundary);
    ...
    case exports.GraphCanvasEvent.Pinch:
      {
        const {
          dx,
          dy,
    ...
    case exports.GraphMinimapEvent.Pan:
      return minimapPan(action.dx, action.dy)(viewport);

    case exports.GraphCanvasEvent.ResetViewport:
      return resetViewport(viewport, data, graphConfig, action);

    case exports.GraphCanvasEvent.ZoomTo:
      if (!isViewportComplete(viewport)) {
        return viewport;
      }
    ...
    case exports.GraphCanvasEvent.ZoomToFit:
      return zoomToFit(viewport, data, settings, action);

    case exports.GraphCanvasEvent.ScrollIntoView:
      if (viewport.rect) {
        const {
          x,
          y
...
function useGraphReducer(params, middleware) {
  const reducer = React__namespace.useMemo(() => getGraphReducer(middleware), [middleware]);
  const [state, dispatchImpl] = React__namespace.useReducer(reducer, params, createGraphState);
  const sideEffects = useConst(() => []);
  const prevStateRef = React__namespace.useRef(state);
  const dispatch = React__namespace.useCallback((action, callback) => {
    if (callback) {
...
const useGetMouseDownOnAnchor = (node, eventChannel) => {
  const graphController = useGraphController();
  return React__namespace.useCallback(f => evt => {
    evt.preventDefault();
    evt.stopPropagation();
    eventChannel.trigger({
      type: exports.GraphNodeEvent.ResizingStart,
      rawEvent: evt,
      node
    });
    ...
    drag.onMove = ({
      ...
      eventChannel.trigger(Object.assign({
        type: exports.GraphNodeEvent.Resizing,
        rawEvent,
        node,
        dx: 0,
        dy: 0,
    ...
    drag.onEnd = ({
      ...
      eventChannel.trigger({
        type: exports.GraphNodeEvent.ResizingEnd,
        rawEvent,
        node
      });
    };
...
const withSimulatedClick = (params, type) => ({
  ...
  if (rawEvent.target instanceof Node && ((_a = containerRef.current) === null || _a === void 0 ? void 0 : _a.contains(rawEvent.target)) && isWithinThreshold(totalDX, totalDY, dragThreshold)) {
    events.push({
      type: exports.GraphCanvasEvent.Click,
      rawEvent
    });
  }
...
const dragMultiSelect = (e, params) => {
  ...
  dragging.onMove = ({
    ...
    eventChannel.trigger({
      type: exports.GraphCanvasEvent.SelectMove,
      rawEvent,
      dx,
      dy
    });
  ...
  dragging.onEnd = withSimulatedClick(params, exports.GraphCanvasEvent.SelectEnd);
  eventChannel.trigger({
    type: exports.GraphCanvasEvent.SelectStart,
    rawEvent: e
  });
  dragging.start(e);
};
...
const dragPan = (e, params) => {
  ...
  dragging.onMove = ({
    ...
    eventChannel.trigger({
      type: exports.GraphCanvasEvent.Drag,
      rawEvent,
      dx,
      dy
    });
  ...
  dragging.onEnd = withSimulatedClick(params, exports.GraphCanvasEvent.DragEnd);
  dragging.start(e);
  eventChannel.trigger({
    type: exports.GraphCanvasEvent.DragStart,
    rawEvent: e
  });
};
...
const onContainerMouseDown = (e, params) => {
  ...
  const isPanMode = canvasMouseMode === exports.CanvasMouseMode.Pan && !e.ctrlKey && !e.shiftKey && !e.metaKey || ((_a = state.activeKeys) === null || _a === void 0 ? void 0 : _a.has(" "));
...
const onNodePointerDown = (evt, target, params) => {
  ...
  dragging.onMove = ({
    ...
    if (isNodesDraggable) {
      eventChannel.trigger({
        type: exports.GraphNodeEvent.Drag,
        node: target,
        dx,
        dy,
        rawEvent: e,
  ...
  dragging.onEnd = ({
    ...
    eventChannel.trigger({
      type: exports.GraphNodeEvent.DragEnd,
      node: target,
      rawEvent: e,
      isDragCanceled
    });
  ...
  eventChannel.trigger({
    type: exports.GraphNodeEvent.DragStart,
    node: target,
    rawEvent: evt,
    isMultiSelect
  });
...
const useCanvasKeyboardEventHandlers = args => {
  ...
  return React__namespace.useMemo(() => {
    ...
    const deleteKeyDownHandler = () => evt => {
      ...
      eventChannel.trigger({
        type: exports.GraphCanvasEvent.Delete
      });
    ...
    const cKeyDownHandler = evt => {
      if (metaControl(evt)) {
        ...
        evt.stopPropagation();
        eventChannel.trigger({
          type: exports.GraphCanvasEvent.Copy
        });
      }
    };
    ...
    const vKeyDownHandler = evt => {
      if (metaControl(evt)) {
        ...
        if (data) {
          eventChannel.trigger({
            type: exports.GraphCanvasEvent.Paste,
            data
          });
        }
      }
    ...
    const zKeyDownHandler = evt => {
      ...
      if (metaControl(evt)) {
        ...
        evt.stopPropagation();
        eventChannel.trigger({
          type: exports.GraphCanvasEvent.Undo
        });
      }
    };
    ...
    const yKeyDownHandler = evt => {
      ...
      if (metaControl(evt)) {
        ...
        evt.stopPropagation();
        eventChannel.trigger({
          type: exports.GraphCanvasEvent.Redo
        });
      }
    };
    ...
    const aKeyDownHandler = evt => {
      if (metaControl(evt)) {
        ...
        evt.stopPropagation();
        eventChannel.trigger({
          type: exports.GraphNodeEvent.SelectAll
        });
      }
    };
...
function useEventChannel({
  ...
  const animationFramedDispatch = React__namespace.useMemo(() => animationFramed(dispatch), [dispatch]);
  ...
  const handleCanvasEvent = event => {
    ...
    switch (event.type) {
      ...
      case exports.GraphCanvasEvent.Copy:
        {
      ...
      case exports.GraphCanvasEvent.MouseDown:
        {
      ...
      case exports.GraphCanvasEvent.MouseUp:
      ...
      case exports.GraphCanvasEvent.MouseMove:
        {
          const evt = event.rawEvent;
      ...
      case exports.GraphCanvasEvent.MouseLeave:
        graphController.unsetMouseClientPosition();
        graphController.canvasClickOnce = false;
        break;

      case exports.GraphCanvasEvent.Blur:
        setFocusedWithoutMouse(false);
        break;
    }
  }; //#endregion canvas
  ...
  const handleNodeEvent = event => {
    ...
    switch (event.type) {
      ...
      case exports.GraphNodeEvent.PointerDown:
        {
          graphController.nodeClickOnce = null;

          if (graphController.getBehavior() !== exports.GraphBehavior.Default) {
            return;
          }
      ...
      case exports.GraphNodeEvent.MouseDown:
        graphController.nodeClickOnce = null;
        event.rawEvent.preventDefault();
      ...
      case exports.GraphNodeEvent.KeyDown:
        onNodeKeyDown(event);
        break;
    }
  }; //#endregion node
  ...
  const onPortPointerDown = React__namespace.useCallback(event => {
    const evt = event.rawEvent;
    const {
      node,
      port
    ...
    dragging.onMove = ({
      ...
      eventChannel.trigger({
        type: exports.GraphEdgeEvent.ConnectMove,
        rawEvent: e,
        clientX,
        clientY
      });
    ...
    dragging.onEnd = ({
      ...
      eventChannel.trigger({
        type: exports.GraphEdgeEvent.ConnectEnd,
        rawEvent: e,
        edgeWillAdd,
        isCancel
      });
    ...
    eventChannel.trigger({
      type: exports.GraphEdgeEvent.ConnectStart,
      nodeId: node.id,
      portId: port.id,
      rawEvent: evt,
      clientPoint: {
  ...
  const onPortPointerUp = React__namespace.useCallback(event => {
    const evt = event.rawEvent;
    const {
      node,
      port
    ...
    if (prevMouseDownPortId === `${node.id}:${port.id}` && performance.now() - (prevMouseDownPortTime || 0) < 500) {
      ...
      eventChannel.trigger({
        type: exports.GraphPortEvent.Click,
        node,
        port,
        rawEvent: evt
      });
  ...
  const onPortKeyDown = event => {
    ...
    switch (evt.key) {
      case "Tab":
        if (isA11yEnable && graphController.getBehavior() === exports.GraphBehavior.Connecting) {
          evt.preventDefault();
          evt.stopPropagation();
          eventChannel.trigger({
            type: exports.GraphEdgeEvent.ConnectNavigate,
            rawEvent: evt
          });
        } else {
      ...
      case "Escape":
        if (graphController.getBehavior() === exports.GraphBehavior.Connecting) {
          evt.preventDefault();
          evt.stopPropagation();
  ...
  const handlePortEvent = event => {
    switch (event.type) {
      ...
      case exports.GraphPortEvent.PointerDown:
        onPortPointerDown(event);
        break;

      case exports.GraphPortEvent.PointerUp:
      ...
      case exports.GraphPortEvent.KeyDown:
        onPortKeyDown(event);
        break;
    }
  }; //#endregion port
  ...
  React__namespace.useImperativeHandle(eventChannel.listenersRef, () => handleEvent);
  React__namespace.useImperativeHandle(eventChannel.externalHandlerRef, () => props.onEvent);
}

const useFeatureControl = features => {
  return React__namespace.useMemo(() => {
    const isNodesDraggable = features.has(exports.GraphFeatures.NodeDraggable);
    const isNodeResizable = features.has(exports.GraphFeatures.NodeResizable);
    const isAutoFitDisabled = !features.has(exports.GraphFeatures.AutoFit);
    const isPanDisabled = !features.has(exports.GraphFeatures.PanCanvas);
    const isMultiSelectDisabled = !features.has(exports.GraphFeatures.MultipleSelect);
    const isLassoSelectEnable = features.has(exports.GraphFeatures.LassoSelect);
    const isNodeHoverViewEnabled = features.has(exports.GraphFeatures.NodeHoverView);
    const isClickNodeToSelectDisabled = !features.has(exports.GraphFeatures.ClickNodeToSelect);
    const isConnectDisabled = !features.has(exports.GraphFeatures.AddNewEdges);
    const isPortHoverViewEnable = features.has(exports.GraphFeatures.PortHoverView);
    const isNodeEditDisabled = !features.has(exports.GraphFeatures.EditNode);
    const isVerticalScrollDisabled = !features.has(exports.GraphFeatures.CanvasVerticalScrollable);
    const isHorizontalScrollDisabled = !features.has(exports.GraphFeatures.CanvasHorizontalScrollable);
    const isA11yEnable = features.has(exports.GraphFeatures.A11yFeatures);
    const isAutoAlignEnable = features.has(exports.GraphFeatures.AutoAlign);
    const isCtrlKeyZoomEnable = features.has(exports.GraphFeatures.CtrlKeyZoom);
    const isLimitBoundary = features.has(exports.GraphFeatures.LimitBoundary);
    const isVirtualizationEnabled = !features.has(exports.GraphFeatures.AutoFit);
    const isEdgeEditable = features.has(exports.GraphFeatures.EditEdge);
    const isDeleteDisabled = !features.has(exports.GraphFeatures.Delete);
    const isPasteDisabled = !features.has(exports.GraphFeatures.AddNewNodes) || !features.has(exports.GraphFeatures.AddNewEdges);
    const isUndoEnabled = features.has(exports.GraphFeatures.UndoStack);
    const isScrollbarVisible = (!isVerticalScrollDisabled || !isHorizontalScrollDisabled || !isPanDisabled) && isLimitBoundary && !features.has(exports.GraphFeatures.InvisibleScrollbar);
    return {
      isNodesDraggable,
      isNodeResizable,
      isAutoFitDisabled,
...
const AlignmentLines = /*#__PURE__*/React__namespace.memo(({
  style
}) => {
...
const NodeFrame = props => {
  ...
  const slotsContext = React__namespace.useContext(SlotsContext);
  return jsxRuntime.jsx(jsxRuntime.Fragment, {
...
const AnimatingNodeGroup = props => {
  ...
  return jsxRuntime.jsx("g", {
    children: dummyNodes.nodes.map(dummyNode => {
      ...
      return jsxRuntime.jsx(Slots.NodeFrame, Object.assign({
        height: height,
        width: width,
        x: x,
        y: y
...
const Connecting = /*#__PURE__*/React__namespace.memo(props => {
  const {
    styles,
    graphConfig,
    viewport,
  ...
  return jsxRuntime.jsx(ConnectingLine, {
...
const GraphContextMenu = ({
  ...
  const [style, setStyle] = React__namespace.useState(Object.assign({}, defaultStyle));
  React__namespace.useLayoutEffect(() => {
  ...
  const [content, setContent] = React__namespace.useState(jsxRuntime.jsx(jsxRuntime.Fragment, {}));
  React__namespace.useEffect(() => {
    const data = state.data.present;
    ...
    if (selectedPortsCount + selectedNodesCount + selectedEdgesCount > 1) {
      menu = contextMenuConfig.getMenu(exports.MenuType.Multi);
    } else if (selectedPortsCount + selectedNodesCount + selectedEdgesCount === 0) {
      menu = contextMenuConfig.getMenu(exports.MenuType.Canvas);
    } else if (selectedNodesCount === 1) {
      menu = contextMenuConfig.getMenu(exports.MenuType.Node);
    } else if (selectedPortsCount === 1) {
      menu = contextMenuConfig.getMenu(exports.MenuType.Port);
    } else {
      menu = contextMenuConfig.getMenu(exports.MenuType.Edge);
    }

    setContent(menu);
  }, [state.data.present, contextMenuConfig]);
  const handleContextMenu = React__namespace.useCallback(evt => {
    evt.stopPropagation();
    evt.preventDefault();
  }, []);
  return jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: state.contextMenuPosition && jsxRuntime.jsx("div", Object.assign({
      ref: ref,
      onClick: onClick,
...
const Renderer = props => jsxRuntime.jsx("rect", {
  height: props.height,
  width: props.width,
...
const Group = props => {
  ...
  const {
    ...
    width,
    height
  } = React__namespace.useMemo(() => getGroupRect(group, data.nodes, graphConfig), [group, data.nodes, graphConfig]);
...
const GraphGroupsRenderer = props => {
  return jsxRuntime.jsx("g", {
    children: React__namespace.useMemo(() => props.groups.map(group => {
...
const NodeTooltips = props => {
  ...
  if (!has(exports.GraphNodeStatus.Activated)(node.status)) {
    return null;
  }
...
const PortTooltips = props => {
  ...
  const isPortTooltipsVisible = has(exports.GraphPortStatus.Activated)(port.status);
  ...
  return jsxRuntime.jsx("div", Object.assign({
    ...
    children: jsxRuntime.jsx(ConnectingStateContext.Consumer, {
      children: ({
        sourceNode,
        sourcePort
...
const Scrollbar = props => {
  ...
  function onVerticalScrollMouseDown(e) {
    ...
    dragging.onMove = ({
      ...
      eventChannel.trigger({
        type: exports.GraphScrollBarEvent.Scroll,
        rawEvent,
        dx: 0,
        dy
      });
    ...
    dragging.onEnd = () => {
      eventChannel.trigger({
        type: exports.GraphScrollBarEvent.ScrollEnd
      });
    };

    dragging.start(e.nativeEvent);
    eventChannel.trigger({
      type: exports.GraphScrollBarEvent.ScrollStart
    });
  }
  /**
   * @param e
  ...
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [vertical && jsxRuntime.jsx("div", Object.assign({
    ...
    })), horizontal && jsxRuntime.jsx("div", Object.assign({
...
const Transform = ({
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps
  const transform = React__namespace.useMemo(() => `matrix(${matrix.join(" ")})`, matrix);
  return jsxRuntime.jsx("g", Object.assign({
    transform: transform
  }, {
    children: children
...
const GraphEdge = /*#__PURE__*/React__namespace.memo( // eslint-disable-next-line complexity
props => {
  var _a;
  ...
  if (has(exports.GraphEdgeStatus.ConnectedToSelected)(edge.status) && (!isSourceVisible || !isTargetVisible)) {
  ...
  return jsxRuntime.jsx("g", Object.assign({
    id: id,
    onClick: edgeEvent(exports.GraphEdgeEvent.Click),
    onDoubleClick: edgeEvent(exports.GraphEdgeEvent.DoubleClick),
    onMouseDown: edgeEvent(exports.GraphEdgeEvent.MouseDown),
    onMouseUp: edgeEvent(exports.GraphEdgeEvent.MouseUp),
    onMouseEnter: edgeEvent(exports.GraphEdgeEvent.MouseEnter),
    onMouseLeave: edgeEvent(exports.GraphEdgeEvent.MouseLeave),
    onContextMenu: edgeEvent(exports.GraphEdgeEvent.ContextMenu),
    onMouseMove: edgeEvent(exports.GraphEdgeEvent.MouseMove),
    onMouseOver: edgeEvent(exports.GraphEdgeEvent.MouseOver),
    onMouseOut: edgeEvent(exports.GraphEdgeEvent.MouseOut),
    onFocus: undefined,
    onBlur: undefined,
    className: className,
    "data-automation-id": automationId
...
const EdgeChampNodeRender = /*#__PURE__*/React__namespace.memo(props => {
  var _a, _b;
  ...
  for (let i = 0; i < valueCount; i += 1) {
    ...
    if (source && target) {
      values.push( /*#__PURE__*/React.createElement(GraphEdge, Object.assign({}, others, {
        key: it.id,
        data: data,
        edge: it,
        source: source,
  ...
  for (let i = 0; i < nodeCount; i += 1) {
    ...
    if (it.type === NodeType$1.Bitmap) {
      children.push(jsxRuntime.jsx(EdgeChampNodeRender, Object.assign({}, props, {
        node: it
      }), node.getHash(i)));
    } else {
      children.push(jsxRuntime.jsx(EdgeHashCollisionNodeRender, Object.assign({}, props, {
        node: it
      }), it.getHash()));
    }
  }
...
const EdgeHashCollisionNodeRender = /*#__PURE__*/React__namespace.memo(props => {
  const {
    data,
    node
  } = props,
  ...
  return jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: node.values.map(edge => {
      ...
      if (source && target) {
        return /*#__PURE__*/React.createElement(GraphEdge, Object.assign({}, others, {
          key: edge.id,
          data: data,
          edge: edge,
          source: source,
...
const EdgeTree = props => {
  ...
  return jsxRuntime.jsx(EdgeChampNodeRender, Object.assign({}, others, {
    node: tree.root
  }));
};

// use static css file here
const styles = mergeStyles.mergeStyleSets({
  svg: [{
    position: "absolute",
    overflow: "hidden",
    top: 0,
...
const GraphNode = props => {
  ...
  const onClick = e => {
    ...
    const isMultiSelect = checkIsMultiSelect(e);
    eventChannel.trigger({
      type: exports.GraphNodeEvent.Click,
      rawEvent: e,
      isMultiSelect,
      node
    });
  ...
  return jsxRuntime.jsx("g", Object.assign({
    ...
    onPointerDown: nodeEvent(exports.GraphNodeEvent.PointerDown),
    onPointerEnter: nodeEvent(exports.GraphNodeEvent.PointerEnter),
    onPointerMove: nodeEvent(exports.GraphNodeEvent.PointerMove),
    onPointerLeave: nodeEvent(exports.GraphNodeEvent.PointerLeave),
    onPointerUp: nodeEvent(exports.GraphNodeEvent.PointerUp),
    onDoubleClick: nodeEvent(exports.GraphNodeEvent.DoubleClick),
    onMouseDown: nodeEvent(exports.GraphNodeEvent.MouseDown),
    onMouseUp: nodeEvent(exports.GraphNodeEvent.MouseUp),
    onMouseEnter: nodeEvent(exports.GraphNodeEvent.MouseEnter),
    onMouseLeave: nodeEvent(exports.GraphNodeEvent.MouseLeave),
    onContextMenu: nodeEvent(exports.GraphNodeEvent.ContextMenu),
    onMouseMove: nodeEvent(exports.GraphNodeEvent.MouseMove),
    onMouseOver: nodeEvent(exports.GraphNodeEvent.MouseOver),
    onMouseOut: nodeEvent(exports.GraphNodeEvent.MouseOut),
    onClick: onClick,
    onKeyDown: nodeEvent(exports.GraphNodeEvent.KeyDown),
...
const NodeAnchor = ({
  ...
  return jsxRuntime.jsx(Slots.NodeResizeHandler, Object.assign({
    x: x,
    y: y,
    cursor: cursor,
...
const GraphNodeAnchors = props => {
  ...
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [jsxRuntime.jsx(NodeAnchor, {
      cursor: "nw-resize",
      x: node.x - BBOX_PADDING,
      y: node.y - BBOX_PADDING - RESIZE_POINT_HEIGHT,
      onMouseDown: nw
    }, "nw-resize"), jsxRuntime.jsx(NodeAnchor, {
      x: node.x + width / 2 - RESIZE_POINT_WIDTH / 2,
      y: node.y - BBOX_PADDING - RESIZE_POINT_HEIGHT,
      cursor: "n-resize",
      onMouseDown: n
    }, "n-resize"), jsxRuntime.jsx(NodeAnchor, {
      x: node.x + width + BBOX_PADDING - RESIZE_POINT_WIDTH,
      y: node.y - BBOX_PADDING - RESIZE_POINT_HEIGHT,
      cursor: "ne-resize",
      onMouseDown: ne
    }, "ne-resize"), jsxRuntime.jsx(NodeAnchor, {
      x: node.x + width + BBOX_PADDING - RESIZE_POINT_WIDTH,
      y: node.y + height / 2 - RESIZE_POINT_HEIGHT / 2,
      cursor: "e-resize",
      onMouseDown: e
    }, "e-resize"), jsxRuntime.jsx(NodeAnchor, {
      x: node.x + width + BBOX_PADDING - RESIZE_POINT_WIDTH,
      y: node.y + height + BBOX_PADDING,
      cursor: "se-resize",
      onMouseDown: se
    }, "se-resize"), jsxRuntime.jsx(NodeAnchor, {
      x: node.x + width / 2 - RESIZE_POINT_WIDTH / 2,
      y: node.y + height + BBOX_PADDING,
      cursor: "s-resize",
      onMouseDown: s
    }, "s-resize"), jsxRuntime.jsx(NodeAnchor, {
      x: node.x - BBOX_PADDING,
      y: node.y + height + BBOX_PADDING,
      cursor: "sw-resize",
      onMouseDown: sw
    }, "sw-resize"), jsxRuntime.jsx(NodeAnchor, {
      x: node.x - BBOX_PADDING,
      y: node.y + height / 2 - RESIZE_POINT_HEIGHT / 2,
      cursor: "w-resize",
      onMouseDown: w
  ...
  return jsxRuntime.jsx("g", {
    children: ports.map(p => {
      ...
      return jsxRuntime.jsx("g", Object.assign({
        ...
        // for IE and Edge
        focusable: "true",
        onPointerDown: portEvent(exports.GraphPortEvent.PointerDown, p),
        onPointerUp: portEvent(exports.GraphPortEvent.PointerUp, p),
        onDoubleClick: portEvent(exports.GraphPortEvent.DoubleClick, p),
        onMouseDown: portEvent(exports.GraphPortEvent.MouseDown, p),
        onMouseUp: portEvent(exports.GraphPortEvent.MouseUp, p),
        onContextMenu: portEvent(exports.GraphPortEvent.ContextMenu, p),
        onPointerEnter: portEvent(exports.GraphPortEvent.PointerEnter, p),
        onPointerLeave: portEvent(exports.GraphPortEvent.PointerLeave, p),
        onMouseMove: portEvent(exports.GraphPortEvent.MouseMove, p),
        onMouseOver: portEvent(exports.GraphPortEvent.MouseOver, p),
        onMouseOut: portEvent(exports.GraphPortEvent.MouseOut, p),
        onFocus: portEvent(exports.GraphPortEvent.Focus, p),
        onBlur: portEvent(exports.GraphPortEvent.Blur, p),
        onKeyDown: portEvent(exports.GraphPortEvent.KeyDown, p),
        onClick: portEvent(exports.GraphPortEvent.Click, p),
...
const GraphNodeParts = _a => {
  ...
  if (isNodeResizable && isNodeEditing(node)) {
    const defaultAnchors = jsxRuntime.jsx(GraphNodeAnchors, {
      node: node,
  ...
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [jsxRuntime.jsx(GraphNode, Object.assign({}, commonProps, {
      node: node,
      viewport: viewport
    })), jsxRuntime.jsx(GraphOneNodePorts, Object.assign({}, commonProps, {
      node: node,
      viewport: viewport
    })), nodeAnchors]
  });
...
const GraphNodePartsMemo = /*#__PURE__*/React__namespace.memo(GraphNodeParts);

const NodeTreeNode = /*#__PURE__*/React__namespace.memo(_a => {
  var {
    node
  } = _a,
  ...
  const values = node.values.map(arg => {
    const it = arg[1];
    return jsxRuntime.jsx(GraphNodePartsMemo, Object.assign({
      node: it
    }, others), it.id);
  });
  const children = node.type === NodeType.Internal ? node.children.map((child, index) => {
    ...
    return jsxRuntime.jsx(NodeTreeNode, Object.assign({
      node: child
    }, others), key);
  }) : undefined;
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
...
const VirtualizationProvider = ({
  ...
  const visibleArea = React__namespace.useMemo(() => getVisibleArea(viewport), [viewport]);
  const contextValue = React__namespace.useMemo(() => ({
    viewport,
    renderedArea,
    visibleArea,
  ...
  const previousContextRef = React__namespace.useRef(context);
  React__namespace.useEffect(() => {
    const previousContext = previousContextRef.current;
    previousContextRef.current = context;
    eventChannel.trigger({
      type: exports.GraphCanvasEvent.VirtualizationRecalculated,
  ...
  return jsxRuntime.jsx(VirtualizationContext.Provider, Object.assign({
    value: context
  }, {
    children: children
  }));
...
const getCursorStyle = ({
  ...
  if (state.behavior === exports.GraphBehavior.Connecting) {
    return "initial";
  }
  ...
  if (canvasMouseMode !== exports.CanvasMouseMode.Pan) {
...
function Graph(props) {
  ...
  const [focusedWithoutMouse, setFocusedWithoutMouse] = React__namespace.useState(false);
  const graphController = useGraphController();
  const {
    state,
    dispatch
  ...
  const graphId = useConst(() => `graph-${uuid.v4()}`);
  const defaultSVGRef = React__namespace.useRef(null);
  const {
  ...
  const [curHoverNode, setCurHoverNode] = React__namespace.useState();
  const [curHoverPort, setCurHoverPort] = React__namespace.useState(undefined);
  const containerRef = React__namespace.useRef(null);
  const rectRef = React__namespace.useRef(undefined);
  ...
  const classes = getGraphStyles(props, state, isPanDisabled, isNodesDraggable, focusedWithoutMouse, state.behavior === exports.GraphBehavior.MultiSelect);
  useWheelHandler({
    containerRef,
    svgRef,
    rectRef,
  ...
  const onContextMenuClick = React__namespace.useCallback(evt => {
    evt.preventDefault();
    evt.stopPropagation();
    eventChannel.trigger({
      type: exports.GraphContextMenuEvent.Close
    });
  ...
  const onFocusButtonClick = React__namespace.useCallback(() => {
    setFocusedWithoutMouse(true);
  ...
  const renderNodeTree = React__namespace.useCallback((tree, layer) => {
    var _a, _b;

    return jsxRuntime.jsx(NodeTree, {
      graphId: graphId,
  ...
  if (!isSupported()) {
    const {
      onBrowserNotSupported = () => jsxRuntime.jsx("p", {
  ...
  const renderPortTooltip = () => {
    ...
    return jsxRuntime.jsx(PortTooltips, {
      port: port,
      parentNode: node,
      data: data,
      viewport: state.viewport
  ...
  const renderNodeTooltip = () => {
    ...
    return jsxRuntime.jsx(NodeTooltips, {
  ...
  return jsxRuntime.jsxs("div", Object.assign({
    ...
    onDoubleClick: canvasEventHandler(exports.GraphCanvasEvent.DoubleClick),
    onMouseDown: canvasEventHandler(exports.GraphCanvasEvent.MouseDown),
    onMouseUp: canvasEventHandler(exports.GraphCanvasEvent.MouseUp),
    onContextMenu: canvasEventHandler(exports.GraphCanvasEvent.ContextMenu),
    onMouseMove: canvasEventHandler(exports.GraphCanvasEvent.MouseMove),
    onMouseOver: canvasEventHandler(exports.GraphCanvasEvent.MouseOver),
    onMouseOut: canvasEventHandler(exports.GraphCanvasEvent.MouseOut),
    onFocus: canvasEventHandler(exports.GraphCanvasEvent.Focus),
    onBlur: canvasEventHandler(exports.GraphCanvasEvent.Blur),
    onKeyDown: canvasEventHandler(exports.GraphCanvasEvent.KeyDown),
    onKeyUp: canvasEventHandler(exports.GraphCanvasEvent.KeyUp)
  }, {
    children: [jsxRuntime.jsx("button", {
      ...
      children: [jsxRuntime.jsx("title", {
        ...
        children: props.desc
      }), jsxRuntime.jsxs(Transform, Object.assign({
        matrix: viewport.transformMatrix
      }, {
        children: [state.viewport.rect && jsxRuntime.jsxs(VirtualizationProvider, Object.assign({
          viewport: state.viewport,
          isVirtualizationEnabled: isVirtualizationEnabled,
          virtualizationDelay: virtualizationDelay,
          eventChannel: eventChannel
        }, {
          children: [background, jsxRuntime.jsx(GraphGroupsRenderer, {
            data: data,
            groups: (_a = data.groups) !== null && _a !== void 0 ? _a : constantEmptyArray()
          }), jsxRuntime.jsx(EdgeTree, {
            graphId: graphId,
            tree: data.edges,
            data: data,
            eventChannel: eventChannel
          }), jsxRuntime.jsx(NodeLayers, {
            data: data,
            renderTree: renderNodeTree
          })]
        })), state.dummyNodes.isVisible && jsxRuntime.jsx(AnimatingNodeGroup, {
          dummyNodes: state.dummyNodes,
          graphData: state.data.present
        }), jsxRuntime.jsx(AlignmentLines, {
          style: (_b = props.styles) === null || _b === void 0 ? void 0 : _b.alignmentLine
        })]
      })), (!isMultiSelectDisabled || isLassoSelectEnable) && jsxRuntime.jsx(SelectBox, {
        selectBoxPosition: state.selectBoxPosition,
        style: (_c = props.styles) === null || _c === void 0 ? void 0 : _c.selectBox
      }), state.connectState && jsxRuntime.jsx(Connecting, {
    ...
    })), isScrollbarVisible && isViewportComplete(state.viewport) && jsxRuntime.jsx(Scrollbar, {
      viewport: state.viewport,
      ...
      eventChannel: eventChannel
    }), jsxRuntime.jsx(GraphContextMenu, {
      state: state,
...
const AddingNodeSvg = ({
  ...
  const dummyNode = React__namespace.useMemo(() => {
  ...
  const tempGraphId = useConst(uuid.v4);
  const node = React__namespace.useMemo(() => NodeModel.fromJSON(attachedNode !== null && attachedNode !== void 0 ? attachedNode : model, undefined, undefined), [attachedNode, model]);
  return jsxRuntime.jsx("svg", Object.assign({
    ...
    children: jsxRuntime.jsx(Transform, Object.assign({
      matrix: viewport.transformMatrix
    }, {
      children: rect && jsxRuntime.jsx(GraphNode, {
        graphId: tempGraphId,
        node: node,
        viewport: {
          rect,
...
const Item = props => {
  const graphConfig = useGraphConfig();
  const graphController = useGraphController();
  const [workingModel, setWorkingModel] = React__namespace.useState(null);
  ...
  const onPointerDown = React__namespace.useCallback(evt => {
    var _a;

    evt.stopPropagation();

    if (isMouseButNotLeft(evt) || !graphController.getEnabledFeatures().has(exports.GraphFeatures.AddNewNodes)) {
      return;
    }
    ...
    eventChannel.trigger({
      type: exports.GraphCanvasEvent.DraggingNodeFromItemPanelStart,
      rawEvent: evt
    });
    ...
    drag.onEnd = ({
      ...
      if (!isViewportComplete(viewport) || !nextNode || !isWithInBound(viewport.rect, e.clientX, e.clientY)) {
        ...
        eventChannel.trigger({
          type: exports.GraphCanvasEvent.DraggingNodeFromItemPanelEnd,
          node: null
        });
        return;
      }
  ...
  const className = mergeStyles.mergeStyles(styles.moduleItem, props.className);
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [jsxRuntime.jsx("div", Object.assign({
      className: className,
      style: style,
      ...
      children: children
    })), workingModel && /*#__PURE__*/ReactDOM__namespace.createPortal(jsxRuntime.jsx(AddingNodeSvg, {
      svgRef: svgRef,
      model: workingModel,
...
const StaticNodeWithMemo = /*#__PURE__*/React__namespace.memo(StaticNode, (prevProps, nextProps) => {
...
const ReadonlyNodeTreeNode = /*#__PURE__*/React__namespace.memo(({
  node
}) => {
  const values = node.values.map(it => jsxRuntime.jsx(StaticNodeWithMemo, {
    node: it[1]
  }, it[1].id));
  const children = node.type === NodeType.Internal ? node.children.map((child, index) => {
    const key = index < node.selfSize ? node.getKey(index) : "last";
    return jsxRuntime.jsx(ReadonlyNodeTreeNode, {
      node: child
    }, key);
  }) : undefined;
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
...
const StaticGraph = props => {
  ...
  return jsxRuntime.jsx("svg", Object.assign({
    ...
    children: jsxRuntime.jsx(Transform, Object.assign({
      ...
      children: jsxRuntime.jsx(ReadonlyNodeTree, {
        tree: nodes
      })
    }))
  }));
...
const MiniMapShadow = ({
  ...
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [viewportStartY > 0 && jsxRuntime.jsxs("g", {
      children: [jsxRuntime.jsx("rect", {
        onClick: onClick,
    ...
    }), viewportStartX && sideShadowHeight > 0 && jsxRuntime.jsxs("g", {
      children: [jsxRuntime.jsx("rect", {
        onClick: onClick,
        onMouseDown: stopPropagation,
        onPointerDown: stopPropagation,
    ...
    }), rightShadowWidth && sideShadowHeight > 0 && jsxRuntime.jsxs("g", {
      children: [jsxRuntime.jsx("rect", {
        onClick: onClick,
        onMouseDown: stopPropagation,
        onPointerDown: stopPropagation,
    ...
    }), bottomShadowHeight > 0 && jsxRuntime.jsxs("g", {
      children: [jsxRuntime.jsx("rect", {
        onClick: onClick,
        onMouseDown: stopPropagation,
        onPointerDown: stopPropagation,
...
const Minimap = props => {
  ...
  const minimapTransformMatrix = React__namespace.useMemo(() => {
    if (!rect) {
  ...
  const viewport = React__namespace.useMemo(() => {
  ...
  const onClick = React__namespace.useCallback(evt => {
    evt.stopPropagation();
    ...
    graphController.eventChannel.batch([{
      type: exports.GraphCanvasEvent.ScrollIntoView,
      x: point.x,
      y: point.y
    }, {
      type: exports.GraphMinimapEvent.Click,
      rawEvent: evt
    }]);
  }, // eslint-disable-next-line react-hooks/exhaustive-deps
  [rect]);
  const onStartDrag = React__namespace.useCallback((evt, eventProvider) => {
    if (!rectRef.current) {
      return;
    }
    ...
    graphController.eventChannel.trigger({
      type: exports.GraphMinimapEvent.PanStart,
      rawEvent: evt
    });
    ...
    drag.onMove = ({
      ...
      graphController.eventChannel.trigger({
        type: exports.GraphMinimapEvent.Pan,
        dx: x,
        dy: y,
        rawEvent: e
      });
    ...
    drag.onEnd = () => {
      graphController.eventChannel.trigger({
        type: exports.GraphMinimapEvent.PanEnd,
        rawEvent: evt
      });
    };
  }, // eslint-disable-next-line react-hooks/exhaustive-deps
  [shadowPadding]);
  const arrowParams = React__namespace.useMemo(() => {
    if (!rect) {
      return {
        showArrow: false,
        arrowDeg: 0
  ...
  const onMouseDown = React__namespace.useCallback(evt => {
    onStartDrag(evt.nativeEvent, new MouseMoveEventProvider(graphController.getGlobalEventTarget()));
  }, // eslint-disable-next-line react-hooks/exhaustive-deps
  [onStartDrag]);
  const touchController = React__namespace.useMemo(() => {
  ...
  const staticGraphEl = React__namespace.useMemo(() => jsxRuntime.jsx(StaticGraph, {
    data: data,
  ...
  return jsxRuntime.jsxs("div", Object.assign({
    ...
    children: [staticGraphEl, jsxRuntime.jsx("svg", Object.assign({
      ...
      children: jsxRuntime.jsx(MiniMapShadow, {
        containerRect: rect,
        viewport: viewport,
...
const ContextMenu = props => {
  const classes = mergeStyles.mergeStyleSets({
    contextMenu: {
      fontSize: 14,
...
const NodeMenu = props => {
  const contextMenuConfig = useContextMenuConfigContext();
  contextMenuConfig.registerMenu(props.children, exports.MenuType.Node);
  return null;
};

const EdgeMenu = props => {
  const contextMenuConfig = useContextMenuConfigContext();
  contextMenuConfig.registerMenu(props.children, exports.MenuType.Edge);
  return null;
};

const PortMenu = props => {
  const contextMenuConfig = useContextMenuConfigContext();
  contextMenuConfig.registerMenu(props.children, exports.MenuType.Port);
  return null;
};

const CanvasMenu = props => {
  const contextMenuConfig = useContextMenuConfigContext();
  contextMenuConfig.registerMenu(props.children, exports.MenuType.Canvas);
  return null;
};

const MultiMenu = props => {
  const contextMenuConfig = useContextMenuConfigContext();
  contextMenuConfig.registerMenu(props.children, exports.MenuType.Multi);
  return null;
};
...
const GridBackground = ({
  ...
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [jsxRuntime.jsxs("defs", {
      children: [jsxRuntime.jsx("pattern", Object.assign({
        id: "smallGrid",
        width: "8",
        height: "8",
        patternUnits: "userSpaceOnUse"
      }, {
        children: jsxRuntime.jsx("path", Object.assign({
          d: "M 8 0 L 0 0 0 8",
          fill: "none",
          stroke: "gray",
          strokeWidth: "0.5"
        }, smallGridAttributes))
      })), jsxRuntime.jsxs("pattern", Object.assign({
        id: "grid",
        width: "80",
        height: "80",
        patternUnits: "userSpaceOnUse"
        ...
        children: [jsxRuntime.jsx("rect", {
          ...
          height: "80",
          fill: "url(#smallGrid)"
        }), jsxRuntime.jsx("path", Object.assign({
          d: "M 80 0 L 0 0 0 80",
          fill: "none",
          stroke: "gray",
          strokeWidth: "1"
    ...
    }), jsxRuntime.jsx("rect", Object.assign({
      x: rectX,
      y: rectY,
      width: width,
      height: height,
...
exports.ACTIVATED_STATUS = ACTIVATED_STATUS;
exports.Bitset = bitset;
exports.CanvasMenu = CanvasMenu;
exports.ContextMenu = ContextMenu;
exports.ContextMenuConfig = ContextMenuConfig;
exports.ContextMenuConfigContext = ContextMenuConfigContext;
exports.DEFAULT_GRAPH_SETTINGS = DEFAULT_GRAPH_SETTINGS;
exports.DEFAULT_NODE_MAX_VISIBLE_SIZE = DEFAULT_NODE_MAX_VISIBLE_SIZE;
exports.DEFAULT_NODE_MIN_VISIBLE_SIZE = DEFAULT_NODE_MIN_VISIBLE_SIZE;
exports.Debug = Debug;
exports.DefaultClipboard = DefaultClipboard;
exports.DefaultStorage = DefaultStorage;
exports.EMPTY_CONNECT_STATE = EMPTY_CONNECT_STATE;
exports.EMPTY_GAP = EMPTY_GAP;
exports.EMPTY_GRAPH_STATE = EMPTY_GRAPH_STATE;
exports.EMPTY_STATUS = EMPTY_STATUS;
exports.EMPTY_TRANSFORM_MATRIX = EMPTY_TRANSFORM_MATRIX;
exports.EMPTY_VIEW_PORT = EMPTY_VIEW_PORT;
exports.EdgeMenu = EdgeMenu;
exports.EdgeModel = EdgeModel;
exports.GanttChartFeatures = GanttChartFeatures;
exports.Graph = Graph;
exports.GraphConfigBuilder = GraphConfigBuilder;
exports.GraphConfigContext = GraphConfigContext;
exports.GraphModel = GraphModel;
exports.GraphNodeAnchors = GraphNodeAnchors;
exports.GraphStateContext = GraphStateContext;
exports.GraphValueContext = GraphValueContext;
...
exports.PortMenu = PortMenu;
exports.RESIZE_POINT_HEIGHT = RESIZE_POINT_HEIGHT;
exports.RESIZE_POINT_WIDTH = RESIZE_POINT_WIDTH;
exports.ReactDagEditor = ReactDagEditor;
exports.SELECTED_STATUS = SELECTED_STATUS;
exports.StaticGraph = StaticGraph;
exports.TestAPI = TestAPI;
exports.ViewportContext = ViewportContext;
exports.allFeatures = allFeatures;
exports.applyDefaultPortsPosition = applyDefaultPortsPosition;
exports.applyHorizontalGraphPortsPosition = applyHorizontalGraphPortsPosition;
...
exports.constantEmptyArray = constantEmptyArray;
exports.createGraphState = createGraphState;
exports.dataReadonlyMode = dataReadonlyMode;
exports.debounce = debounce;
exports.defaultFeatures = defaultFeatures;
exports.defaultGetPositionFromEvent = defaultGetPositionFromEvent;
exports.defaultGraphStateContext = defaultGraphStateContext;
exports.defaultPort = defaultPort;
exports.diffGraphEdge = diffGraphEdge;
exports.diffGraphNode = diffGraphNode;
exports.diffGraphPort = diffGraphPort;
exports.distance = distance;
exports.filterSelectedItems = filterSelectedItems;
exports.focusArea = focusArea;
exports.getBrowser = getBrowser;
exports.getClientDeltaByPointDelta = getClientDeltaByPointDelta;
exports.getClientPointFromRealPoint = getClientPointFromRealPoint;
exports.getContainer = getContainer;
exports.getContainerCenter = getContainerCenter;
exports.getContainerClientPoint = getContainerClientPoint;
exports.getContentArea = getContentArea$1;
exports.getCriticalPath = getCriticalPath;
exports.getCurvePathD = getCurvePathD;
exports.getEdgeSourceTargetCoordinate = getEdgeSourceTargetCoordinate;
exports.getEdgeUid = getEdgeUid;
exports.getGraphReducer = getGraphReducer;
exports.getGroupRect = getGroupRect;
exports.getLinearFunction = getLinearFunction;
exports.getMinimapRect = getMinimapRect;
exports.getNearestConnectablePort = getNearestConnectablePort;
exports.getNeighborPorts = getNeighborPorts;
exports.getNodeAutomationId = getNodeAutomationId;
...
exports.getOffsetLimit = getOffsetLimit;
exports.getPointDeltaByClientDelta = getPointDeltaByClientDelta;
exports.getPortAutomationId = getPortAutomationId;
exports.getPortPosition = getPortPosition;
exports.getPortPositionByPortId = getPortPositionByPortId;
exports.getPortUid = getPortUid;
exports.getRealPointFromClientPoint = getRealPointFromClientPoint;
exports.getRectHeight = getRectHeight;
exports.getRectWidth = getRectWidth;
exports.getRelativePoint = getRelativePoint;
exports.getRenderedArea = getRenderedArea;
exports.getRenderedEdges = getRenderedEdges;
exports.getRenderedNodes = getRenderedNodes;
exports.getScaleLimit = getScaleLimit;
exports.getScaleRange = getScaleRange;
exports.getTopoSortingNodes = getTopoSortingNodes;
exports.getVisibleArea = getVisibleArea;
exports.getVisibleNodes = getVisibleNodes;
exports.getZoomFitMatrix = getZoomFitMatrix;
exports.isActivated = isActivated;
exports.isCanvasEvent = isCanvasEvent;
exports.isConnectable = isConnectable;
exports.isEdgeEvent = isEdgeEvent;
exports.isMacOs = isMacOs;
exports.isMobile = isMobile;
exports.isNodeEditing = isNodeEditing;
exports.isNodeEvent = isNodeEvent;
exports.isNodeVisible = isNodeVisible;
exports.isPointInRect = isPointInRect;
exports.isPointVisible = isPointVisible;
exports.isPortEvent = isPortEvent;
exports.isRectVisible = isRectVisible;
exports.isSelected = isSelected;
exports.isSupported = isSupported;
exports.isViewportComplete = isViewportComplete;
exports.isViewportEmpty = isViewportEmpty;
exports.isWithinRect = isWithinRect;
exports.isWithinThreshold = isWithinThreshold;
exports.line = line;
exports.markCriticalPath = markCriticalPath;
exports.markEdgeDirty = markEdgeDirty;
exports.memoize = memoize;
exports.minimapPan = minimapPan;
...
exports.rect = rect;
exports.redo = redo;
exports.resetConnectStatus = resetConnectStatus;
exports.resetNodePortsState = resetNodePortsState;
exports.resetUndoStack = resetUndoStack;
exports.resolveValueOrCallback = resolveValueOrCallback;
exports.reverseTransformPoint = reverseTransformPoint;
exports.scrollIntoView = scrollIntoView;
exports.setData = setData;
exports.stopPropagation = stopPropagation;
exports.transformPoint = transformPoint;
exports.unSelectAllEntity = unSelectAllEntity;
exports.undo = undo;
exports.updateData = updateData;
exports.updateStatus = updateStatus;
exports.useAlignmentLines = useAlignmentLines;
exports.useBackgroundRect = useBackgroundRect;
exports.useConnectingState = useConnectingState;
exports.useContainerRect = useContainerRect;
exports.useContextMenuConfigContext = useContextMenuConfigContext;
exports.useDeferredValue = useDeferredValue;
exports.useGetMouseDownOnAnchor = useGetMouseDownOnAnchor;
exports.useGraphConfig = useGraphConfig;
exports.useGraphController = useGraphController;
exports.useGraphData = useGraphData;
exports.useGraphReducer = useGraphReducer;
exports.useGraphState = useGraphState;
exports.useGraphTouchHandler = useGraphTouchHandler;
exports.useMinimapRect = useMinimapRect;
exports.useRenderedArea = useRenderedArea;
exports.useSafariScale = useSafariScale;
exports.useSelectBox = useSelectBox;
exports.useThrottle = useThrottle;
exports.useUpdateViewportCallback = useUpdateViewportCallback;
