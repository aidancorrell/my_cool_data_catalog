...
export type RenderNodeAnchors<NodeData = unknown, PortData = unknown> = (node: NodeModel<NodeData, PortData>, getMouseDown: GetMouseDown, defaultAnchors: JSX.Element) => JSX.Element;
