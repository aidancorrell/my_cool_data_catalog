...
export declare enum CanvasMouseMode {
    Pan = "Pan",
    Select = "Select"
}
export declare enum GraphBehavior {
    Default = "default",
    Dragging = "dragging",
    Panning = "panning",
...
export interface IGraphDataState<NodeData = unknown, EdgeData = unknown, PortData = unknown> extends IHistory<GraphModel<NodeData, EdgeData, PortData>> {
}
